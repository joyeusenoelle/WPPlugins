...
function WRSVP_page_body() {
	...
	var wajaxurl = \"" . plugins_url("ajax/admin/wrsvp.php",__FILE__) . "\";
	var directory = \"" . ABSPATH . '/wp-content/plugins/ka-frontpage/images/' . "\";
	...
	echo "<script type=\"text/javascript\" src=\"" . plugins_url("js/wrsvp.js") . \"></script>";
	$wm = new MUMaster();
